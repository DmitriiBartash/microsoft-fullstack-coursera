...
/// <summary>
/// In-memory demo accounts shared by the API and the Studio. A real store would persist users
/// and compare a salted password hash, never plaintext.
/// </summary>
public class UserStore
{
    ...
    [
        ...
        new User { Username = "alice", Password = "pa55",     Role = "user"  },
    ];
